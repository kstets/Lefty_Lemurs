...
Put into an Excel file and put THAT into R
```{r}
FoodGrasps <- read.csv("~/Documents/GitHub/Lefty_Lemurs/Food Grasps.csv")
```

Nevermind I need to find type of grasp by species first
```{r}
left_fg <-
  l_foodGrasps %>%
  filter(Side == "L")
